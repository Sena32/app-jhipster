...
import { MusicaComponent } from 'app/entities/musica/musica.component';
import { MusicaService } from 'app/entities/musica/musica.service';
import { Musica } from 'app/shared/model/musica.model';

describe('Component Tests', () => {
  describe('Musica Management Component', () => {
    let comp: MusicaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MusicaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.musicas && comp.musicas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
